...
class introConfig(object):
    ...
    LOGS_LOCATION = os.environ.get('DIR_LOCATION') or "/mnt/csae48d5df47deax41bcxbaa/SherpaVideos/logs/introGen"
    VIDEOS_LOCATION = os.environ.get('VIDEOS_LOCATION') or "/mnt/csae48d5df47deax41bcxbaa/SherpaVideos/Videos/"
    QUE_LOCATION = os.environ.get('QUE_LOCATION') or "/mnt/csae48d5df47deax41bcxbaa/SherpaVideos/Videos/templateque/"
